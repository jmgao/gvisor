...
// SetForkPolicy implements the semantics of madvise MADV_DONTFORK.
func (mm *MemoryManager) SetForkPolicy(addr usermem.Addr, length uint64, dontfork bool) error {
